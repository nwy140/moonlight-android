...
But I could not perform alt tab on my xiaomi pad 7, but alt tab works well on the no-keyboard-shortcut repo with its accessibility setting, you might also need to allow restricted settings in the App's settings for the accessibility setting to work. 
The shortcuts also seems to work better on Xiaomi Pad 7 Workstation Mode.
